...
const sendMailAndcreateDir = async (insertId, username, email, res) => {
  ...
  let url = `http://localhost:${
    ...
    options = {
      to: email,
      subject: 'Activate your FinEdge account',
      html: `<span>Hello ${username}, You received this message because you created an account on FinEdge.<span><br><span>Click the button below to activate your account and start exploring investment insights.</span><br><br><a href='${url}' style='border: 1px solid #00E676; font-weight: 600; color: #0B0F19; border-radius: 3px; cursor: pointer; outline: none; background: #00E676; padding: 4px 15px; display: inline-block; text-decoration: none;'>Activate Account</a>`,
    }
