    ...
    <div className="m_n_wrapper">
      <div className="m_n">
        <ul className="m_n_ul">
          ...
          <SidebarLink link="/explore" label="Market Discover" />
          <SidebarLink
            link="/notifications"
            label="Market Alerts"
            showNumbers
          ...
          <SidebarLink
            ...
            numbers={uc}
          />
          <SidebarLink link={`${profile}/bookmarks`} label="Watchlists" />
          <SidebarLink link={`${profile}/gallery`} label="Gallery" />
          <SidebarLink link={`${profile}/favourites`} label="Favourites" />
          <SidebarLink link={`${profile}/groups`} label="Investment Clubs" />
          <SidebarLink
            link={`${profile}/recommendations`}
            label="Recommendations"
          />
          <SidebarLink link="/edit-profile" label="Investor Profile" />
