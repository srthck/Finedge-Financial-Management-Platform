      ...
      <Fragment>
        ...
        {blockUser && (
          <Prompt
            ...
            content={`${username} will no longer be able to follow, message, comment, recommend or add you in any Investment Club. FinEdge will not notify ${username} that you blocked them. You can unblock from settings.`}
            actionText="Block"
